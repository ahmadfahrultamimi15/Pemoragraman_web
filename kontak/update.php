...
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        ...
        $notelp = isset($_POST['no_telpon']) ? $_POST['no_telpon'] : '';
        $pekerjaan = isset($_POST['pekerjaan']) ? $_POST['pekerjaan'] : '';
        
        // Update the record
        $stmt = $pdo->prepare('UPDATE kontak SET id = ?, nama = ?, email = ?, no_telpon = ?, pekerjaan = ? WHERE id = ?');
...
<div class="content update">
    ...
    <form action="update.php?id=<?=$contact['id']?>" method="post">
        ...
        <input type="text" name="no_telpon" value="<?=$contact['no_telpon']?>" id="no_telpon">
